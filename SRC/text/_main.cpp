...
int __main(int argc, char* agrv[])
{
    ...
    // Create fonts
    TTFont font0(ft, "../fonts/NotoSans-Regular.ttf", 56, content_scale, false, true);
    if (!font0.Ok())
    {
        fprintf(stderr, "create font0 failed\n");
        return 1;
    }
    TTFont font1(ft, "../fonts/NotoSerifSC-Regular.otf", 32, content_scale, false, false);
    if (!font1.Ok())
    {
        fprintf(stderr, "create font1 failed\n");
        return 1;
    }
    TTFont font2(ft, "../fonts/NotoSansArabic-Regular.ttf", 56, content_scale, true, false);
    if (!font2.Ok())
    {
