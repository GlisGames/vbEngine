...
struct MeshCallback {
    virtual void drawGlyph(const Quad& quad, const AtlasGlyph& glyph, bool newLine) = 0;
    virtual void drawGlyph(const Rect& rect, const AtlasGlyph& glyph, bool newLine) = 0;
};
